...
import csv
with open('case3.csv', 'w', newline='') as file:
    ...
    reserve_contract.buyShq(accounts[0], 2 * 10**18, {'from' : accounts[0]})
    sheqeltoken.transfer("0x0000000000000000000000000000000000000000", 2 * 10**18, {'from' : accounts[0]})
